...
void InteractionInitialisation()
{
	...
	multi_reciv = new multicast_net("224.10.12.70", 10001);      // Object do odbioru ramek sieciowych
	multi_send = new multicast_net("224.10.12.70", 10001);       // Object do wysy³ania ramek
	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR 2019/20, temat 4, wersja c [Y-autopilot, F10-test autop.]", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
		50, 100, 1400, 900, NULL, NULL, hInstance, NULL);
